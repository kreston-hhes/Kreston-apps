    ...
    <div class="w-full max-w-lg rounded-2xl bg-white p-6 dark:bg-gray-900">
        ...
        <div class="mt-6 space-y-4">
            ...
            <div>
                ...
                <p id="modal-ticket-status" class="inline-flex w-fit rounded-full px-3 py-1 text-sm font-medium"></p>
            </div>

            <div>
                <p class="text-sm text-gray-500">Requester</p>
                <p id="modal-ticket-requester" class="font-medium text-gray-800 dark:text-white"></p>
            </div>

            <div>
                <p class="text-sm text-gray-500">Partner Team</p>
                <p id="modal-ticket-partner" class="font-medium text-gray-800 dark:text-white"></p>
            </div>

            <div>
                <p class="text-sm text-gray-500">Description</p>
                <p id="modal-ticket-description" class="font-medium text-gray-800 dark:text-white"></p>
            </div>

            <div>
                <p class="text-sm text-gray-500">Solution</p>
                <p id="modal-ticket-solution" class="font-medium text-gray-800 dark:text-white"></p>
            </div>

            <div>
                <p class="text-sm text-gray-500">Support By</p>
                <p id="modal-ticket-support" class="font-medium text-gray-800 dark:text-white"></p>
            </div>

            <div>
                <p class="text-sm text-gray-500">Created At</p>
                <p id="modal-ticket-created" class="font-medium text-gray-800 dark:text-white"></p>
            </div>
